...
public class AppConstants {
	...
	public static final List<String>EXPECTED_ACCOUNT_HEADER_LIST=Arrays.asList("My Account",
			"My Orders",
...
//env data :properties file-browser name,browser version, test name= headless, incognito, highlight 
//url, username, password, huburl, remote